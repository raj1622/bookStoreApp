...
function Navbar() {
    ...
    return (
        <>
            <div className={`fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white ${
                sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease=in-out":""
            }`}>
                <div className="navbar w-auto ml-7 mr-7">
                    ...
                    <div className="navbar-end w-full ">
                        ...
                        <div className='ml-4'>
                            <label className="swap swap-rotate">
                                ...
                                {/* sun icon */}
                                <svg className="swap-off fill-current w-8.5 h-8.5" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className='ml-4'>
                        <a className="bg-black text-white px-3 py-2.5 rounded-md hover:bg-slate-800 duration-300 cursor-pointer 
